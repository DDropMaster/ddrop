    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Measurements", t => t.DropId)
                .Index(t => t.DropId);
        }
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Measurements", "CurrentSeriesId", "dbo.Series");
            ...
            DropIndex("dbo.Measurements", new[] {"CurrentSeriesId"});
